...
class SalesExchange extends StatefulWidget {
  const SalesExchange({super.key});

  @override
  State<SalesExchange> createState() => _SalesExchangeState();
}

class _SalesExchangeState extends State<SalesExchange> {
 String? userSelected;
